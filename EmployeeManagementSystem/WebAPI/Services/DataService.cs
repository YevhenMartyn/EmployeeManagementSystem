...
namespace WebAPI.Services
{
    public static class DataService
    {
        ...
        static DataService()
        {
            ...
            AddDepartment(new Department { Id = 1, Name = "department1" });
            AddDepartment(new Department { Id = 2, Name = "department2" });

            Employees = new Dictionary<int, Employee> { };
            AddEmployee(new Employee { Id = 1, Name = "employee1", Position = "position1", Department = GetDepartmentById(1), StartDate = new DateTime(2023, 4, 7) });
            AddEmployee(new Employee { Id = 2, Name = "employee2", Position = "position2", Department = GetDepartmentById(2), StartDate = new DateTime(2023, 7, 15) });
            AddEmployee(new Employee { Id = 3, Name = "employee3", Position = "position3", Department = GetDepartmentById(2), StartDate = new DateTime(2023, 9, 18) });
        }

        // Employees ----------------

        public static List<Employee> GetAllEmployees() => Employees.Values.ToList();
        public static Employee? GetEmployeeById(int id) => Employees.GetValueOrDefault(id);
        ...
        public static Department? GetDepartmentById(int id) => Departments.GetValueOrDefault(id);
